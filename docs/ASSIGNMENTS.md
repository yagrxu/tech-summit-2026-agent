...
| `quest_xingyun` | 星云智能 | 智能制造/智能家居出海 | 1 洽谈中 | **409** | **Petrel-9** | 2026-09-23 起 | `t_doc2` 重试 4/10 → 10/10；下一步攻合规否决林雪琴 |
| `quest_verikon` | 维立康制药 | HCLS 跨国药企 | 0 | 0 | **Kestrel-7** | 2026-09-23 13:2x 起 | 满分 1000（最高上限）；2 道 `cde_rest` + PDF + 录屏 —— ME Live 已把 REST 工具链跑热，这家性价比最高 |
